...
export default function PresentationJO() {
  ...
  useEffect(() => {
    gsap.utils.toArray('.ring-left').forEach(element => {
      gsap.fromTo(element, 
        { x: '-50%' }, 
        {
          x: 0, 
    ...
    gsap.utils.toArray('.ring-right').forEach(element => {
      gsap.fromTo(element, 
        { x: '50%' }, 
        {
          x: 0, 
  ...
  return (
    <div className="h-fit w-full mt-5 sm:mt-10" id="presentation">
        ...
        <img src="/anneaux4.png" alt="anneaux olympiques" className="w-fit hidden lg:block absolute -z-10 ring-left opacity-0" />
        <img src="/anneaux3.png" alt="anneaux olympiques" className="w-fit hidden lg:block absolute mt-96 -z-10 ring-left opacity-0" />
        <img src="/anneaux2.png" alt="anneaux olympiques" className="w-fit hidden lg:block absolute mt-96 right-0 -z-10 ring-right opacity-0" />
        <img src="/anneaux1.png" alt="anneaux olympiques" className="w-fit hidden lg:block absolute right-0 -z-10 ring-right opacity-0" />
        <div className="flex flex-col justify-center items-center w-full gap-5 px-5">
        <h1 className="text-4xl sm:text-6xl xl:text-8xl text-black font-bold text-center text-gsap">Les Jeux Olympiques <br/> Paris 2024</h1>
        <Image src="/logoOlympique.png" alt="Paris 2024" width={100} height={100} className="text-gsap"/>
        </div>

        <div className="w-full flex justify-center mt-5 sm:mt-10 px-5 text-gsap">
