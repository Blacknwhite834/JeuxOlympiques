...
export default function Homepage() {
    ...
    return (
        <div className="w-full h-[calc(100dvh)] bg-[url('/background.webp')] bg-cover bg-center flex flex-col bg-image">
            ...
            <Image src="/logoOlympique.png" alt="Paris 2024" width={100} height={100} className="title opacity-0 "/>
            <h1 className="title opacity-0  text-center text-white text-4xl sm:text-6xl xl:text-8xl font-bold w-full md:w-3/4">Vivez l'esprit Olympique au cœur de la France !</h1>
            <Link href="#presentation" className="title opacity-0 bg-white text-black px-5 py-2 rounded-full mt-5 flex items-center gap-3 text-xl hover:bg-opacity-70">
            Découvrir 
