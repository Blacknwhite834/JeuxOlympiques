...
export default function Footer() {
    return (
        <footer className="h-fit w-full rounded-tl-[10px] rounded-tr-[10px] sm:rounded-tl-[50px] sm:rounded-tr-[50px] bg-black mt-10 sm:mt-16 py-10 sm:py-16 flex justify-center items-center gap-3 sm:gap-5 flex-col sm:flex-row">
